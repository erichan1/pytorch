...
def profile_opacus(model, train_loader, optimizer, device, nwarmup=0, profile_folder='opacus_profile', profile_detailed=False):
    # TODO: add warmup?
    ...
    print(f"Saved TensorBoard Profiler traces to {profile_folder}.")
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        profile_opacus(model, train_data_loader, optimizer, torch.device("cuda"), profile_detailed=False)
